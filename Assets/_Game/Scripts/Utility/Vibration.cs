...
public static class Vibration
{
    ...
    /// Tiny pop vibration
    ///</summary>
    public static void VibratePop(int amplitude = 50)
    {
        if (Application.isMobilePlatform)
        {
#if UNITY_IOS
    ...
    ///</summary>
    public static void Vibrate(long milliseconds, int amplitude = 50)
    {
        ...
        if (Application.isMobilePlatform)
        {
            ...
            if (AndroidVersion >= 26)
            {
                AndroidJavaObject createOneShot = vibrationEffect.CallStatic<AndroidJavaObject>("createOneShot", milliseconds, 50);
